...
public class ApplicationState implements IApplicationState, Serializable {
    ...
    private ICommand copyPasteCommand;
	...
	@Override
	public void setCopyPasteCommand(ICommand newCommand) {
		this.copyPasteCommand = newCommand;
	}

	@Override
	public ICommand getCopyPasteCommand() {
